...
De endpoints van de backend zijn opgedeeld per apparaat. Dit wil zeggen dat alle requests voor het apparaat in kwestie naar de endpoint van het apparaat in kwestie worden doorgestuurd. In afbeelding \ref{fig:api-endpoints} vindt u de endpoints van de api terug.

\begin{figure}[h]
    \includegraphics[width=10cm]{./graphics/list-api-endpoints.png}
    \caption{Een lijst met alle endpoints van de backend.}
